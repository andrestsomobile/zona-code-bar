...
public class gstusuario extends GstTabla {
	...
	public boolean crearusuario(String usunombre, String usulogin, String usuclave, String usumail, String usugrupo, String usucompania, String usucedula, String usucodcliente) throws SQLException {
		String insert = "INSERT INTO usuario (usunombre,usulogin,usuclave,usumail,usugrupo,usucompania,usucedula,usucodcliente) VALUES (" + (usunombre == null ? "NULL" : "'" + usunombre + "'") + "," + (usulogin == null ? "NULL" : "'" + usulogin + "'") + ","
				+ (usuclave == null ? "NULL" : "'" + usuclave + "'") + "," + (usumail == null ? "NULL" : "'" + usumail + "'") + "," + (usugrupo == null ? "NULL" : "'" + usugrupo + "'") + "," + (usucompania == null ? "NULL" : "'" + usucompania + "'") + "," + (usucedula == null ? "NULL" : "'" + usucedula + "'") + ","
	...
	public boolean updateusuario(usuario entity) throws SQLException {
		String cad = " update usuario set  " + " usunombre = " + (entity.getusunombre() == null ? "NULL" : "'" + entity.getusunombre() + "'") + "," + " usulogin = " + (entity.getusulogin() == null ? "NULL" : "'" + entity.getusulogin() + "'") + "," + " usuclave = "
				...
				+ " usucompania = " + (entity.getusucompania() == null ? "NULL" : "'" + entity.getusucompania() + "'") + "," + " usucedula = " + (entity.getusucedula() == null ? "NULL" : "'" + entity.getusucedula() + "'") + "," + " usucodcliente = " + (entity.getusucodcliente() == null ? "NULL" : "'" + entity.getusucodcliente() + "'") + " where usucodsx = " + entity.getusucodsx();
	...
	public boolean updateusuario(usuarioForm entity) throws SQLException {
		String cad = " update usuario set  " + " usunombre = " + (entity.getusunombre() == null ? "NULL" : "'" + entity.getusunombre() + "'") + "," + " usulogin = " + (entity.getusulogin() == null ? "NULL" : "'" + entity.getusulogin() + "'") + "," + " usuclave = "
				+ (entity.getusuclave() == null ? "NULL" : "'" + entity.getusuclave() + "'") + "," + " usumail = " + (entity.getusumail() == null ? "NULL" : "'" + entity.getusumail() + "'") + "," + " usugrupo = " + (entity.getusugrupo() == null ? "NULL" : "'" + entity.getusugrupo() + "'") + "," + " usucedula = " + (entity.getusucedula() == null ? "NULL" : "'" + entity.getusucedula() + "'") + ","
				+ " usucompania = " + (entity.getusucompania() == null ? "NULL" : "'" + entity.getusucompania() + "'") + "," + " usucedula = " + (entity.getusucedula() == null ? "NULL" : "'" + entity.getusucedula() + "'") + "," + " usucodcliente = " + (entity.getusucodcliente() == null ? "NULL" : "'" + entity.getusucodcliente() + "'") + " where usucodsx = " + entity.getusucodsx();
		int resp = db.executeUpdate(cad);
		if (resp > 0) {
			crearrol(entity.getusulogin());
