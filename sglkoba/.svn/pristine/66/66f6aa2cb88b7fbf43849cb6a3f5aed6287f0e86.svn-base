...
select distinct fletipoveh from flete 

UPDATE flete set fletipoveh = 'MULA' where fletipoveh = 'TRACTOMULA'

select * from despacho where desptipoveh = 'MULA' and despcostoflete is null

update 
--SELECT * FROM
despacho 
--set despfechafLete = despfechaflete 
where despestado = 'FINALIZADO'  and despfecha >= '2020-01-01' 
and despcostoflete = 0 --is null 
and desptipoveh = 'MULA'