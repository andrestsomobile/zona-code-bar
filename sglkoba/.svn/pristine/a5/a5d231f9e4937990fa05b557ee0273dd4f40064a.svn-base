...
public class interface943 implements java.io.Serializable  {
	/**
	 * 
	 */
	...
	public interface943(String intcodsx, String usucodsx, String usulogin, String intfecha, String intfilecode,
			String intfilename, String trafcodsx) {
		super();
	...
	public interface943(String intcodsx, String usucodsx, String usulogin, String intfecha, String intfilecode,
			String intfilename, String trafcodsx, String intcontenidoarchivo) {
		super();
		this.intcodsx = intcodsx;
		this.usucodsx = usucodsx;
		this.usulogin = usulogin;
